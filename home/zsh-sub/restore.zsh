...
export ADF_RESTORATION_OVERWRITTEN_FILES="$HOME/.autodtofiles-restoring-$(date +%s)"

echo "INFO: Moving all overwritten files to: $ADF_RESTORATION_OVERWRITTEN_FILES"
